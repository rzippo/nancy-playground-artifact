# Nancy Playground
## _A command-line interpreter for Deterministic Network Calculus_

Nancy Playground is a command-line interpreter implementing min-plus and max-plus operators for for Deterministic Network Calculus.

It is meant to be compatible with code written for [RTaW min-plus playground](https://www.realtimeatwork.com/minplus-playground).
